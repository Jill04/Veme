...
abstract contract VemeStorage{
    
  mapping(uint256 => address[]) public remixerList;
  ...
  uint256 public VeMeId = 0;
}
contract Veme is Ownable, ERC165, IERC1155, IERC1155MetadataURI,VemeStorage {
    ...
    function uri(uint256 _tokenId) public view virtual override returns (string memory) {
        require(exists(_tokenId), "ERR_Metadata: URI query for nonexistent token");
    ...
    function setCreatorRevuneRate(uint256 _rate)external onlyOwner{
        creatorRevenueRate = _rate;
    }
     ...
     */
    function _setURI(string memory newuri) external virtual {
        _uri = newuri;
    }
